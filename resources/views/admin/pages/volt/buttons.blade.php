...
@section('content')
    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            ...
            <div>
                <a href="/documentation/components/buttons/index.html" class="btn btn-outline-gray" target="_blank"><i
                        class="far fa-question-circle me-1"></i> Buttons Docs</a>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <br>
                            <button class="btn btn-icon-only btn-youtube d-inline-flex align-items-center"
                                    type="button">
                                <svg class="icon icon-xxs" aria-hidden="true" focusable="false" data-prefix="fab"
                                     data-icon="youtube" role="img" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 576 512">
                            ...
                            <br>
                            <button class="btn btn-icon-only btn-behance d-inline-flex align-items-center"
                                    type="button">
                                <svg class="icon icon-xxs" aria-hidden="true" focusable="false" data-prefix="fab"
                                     data-icon="behance" role="img" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 576 512">
